...
\sisetup{
    ...
    table-format = 1.4e2,           % Specify number format: 1 digit before, 3 after decimal, and 1 exponent
	...
	\begin{table}[]
		...
		\makebox[\linewidth]{
			\begin{tabular}{|l|S|l|S|S|}
				\hline
				funkcja           & {wynik}      & {n}     & {wynik}     & {błąd}  \\
				podcałkowa            & {dokładny}   & {}      & {uzyskany}  & {bezwzględny}   \\
				\hline
